    ...
    def check_options(self, options):
        ...
        if options.remote_flag.lower() == 'y':
            if options.browser_version is not None:
                ...
                result_flag = False
                print(
                    "Browser version cannot be None. Use --ver to specify a browser version")
        ...
        if options.mobile_os_version is not None:
            ...
            result_flag = False
            print(
                "The mobile operating system version cannot be None. Use -H to specify an OS version.")
        ...
        if options.app_package is not None:
            ...
            result_flag = False
            print(
                "The application package name cannot be None. Use -J to specify application package name.")
        ...
        if options.app_activity is not None:
            ...
            result_flag = False
            print(
                "The application activity name cannot be None. Use -K to specify application activity name.")
